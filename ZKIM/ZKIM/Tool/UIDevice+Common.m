...
{
    NSData *deviceToken = [userDefaults objectForKey:@"text"];
    if (deviceToken) {
...
//    NSDictionary *mi_info = [userDefaults objectForKey:@"text"];
//    NSString *mi_regid = mi_info?[mi_info objectForKey:@"regid"]:@"";
//    
//    NSDictionary *biData = @{@"udid":[AppUDID value], @"client_version":version, @"model":[UIDevice deviceModel], @"name":name,
